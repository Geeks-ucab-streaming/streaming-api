...
export class UserObjectMother {
  static createUser() {
      ...
      , UserPhoneFactory.phoneFactoryMethod(new PhoneParameterObject("9d934281-d626-44e4-8e1f-14b17504823b","4121234567","a9ebe28a-26fb-4f73-9a81-088a31211d98","Digitel"))
      , userSuscriptionState.create("premium",new Date(Date.now()))
      , [TokenEntity.create("dfhygzT0QZG8Qt2gavQIdI:APA91bHr1cGJCUK9cfW7UuYOqH-dfqfRxP1Gp61riytbvoS7Y3kjRCu2NMGxb44wp_ChfCWbxDgbJ7W-4yTewALy4frn54S9sMcK5cN-XiKln9OcZfdFgrFydyffvH2wFtk5kCw20Pst"
